...
class VamsMomentumPortfolioStrategy(BaseMomentumPortfolioStrategy):
    """VAMS-style momentum (placeholder minimal version).

    Implements a simplified momentum scoring; full VAMS specifics can be
    layered by users via inheritance under `strategies/user/**`.
    """
...
__all__ = ["VamsMomentumPortfolioStrategy"]
