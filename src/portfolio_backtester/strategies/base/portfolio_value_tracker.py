...
class PortfolioValueTracker:
    ...
    def get_position_summary(self, date: Optional[pd.Timestamp] = None) -> Dict[str, Dict[str, float]]:
        """
        ...
        for asset, position in self._positions.items():
            summary[asset] = {
                ...
                'strategy_contributions': position.strategy_contributions.copy()
            }
