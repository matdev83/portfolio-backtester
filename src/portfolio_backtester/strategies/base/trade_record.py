...
class TradeRecord:
    ...
    def __str__(self) -> str:
        ...
        return (f"TradeRecord({self.date.date()}, {self.asset}, "
    ...
    def __repr__(self) -> str:
        ...
        return (f"TradeRecord(date={self.date}, asset='{self.asset}', "
...
class PositionRecord:
    ...
    def __str__(self) -> str:
        ...
        return (f"Position({self.asset}: {position_type} {abs(self.quantity):.2f} "
