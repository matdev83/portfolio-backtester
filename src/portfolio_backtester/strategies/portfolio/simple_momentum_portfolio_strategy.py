"""
Simple momentum portfolio strategy - a minimal concrete implementation.

This is a demonstration/example strategy that should not be extended.
For creating new momentum strategies, inherit from BaseMomentumPortfolioStrategy directly.
"""
