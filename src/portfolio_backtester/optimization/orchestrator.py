...
class ProgressTracker:
    ...
    def should_stop(self) -> bool:
        ...
        if (self.early_stop_patience is not None and 
            self.evaluations_without_improvement >= self.early_stop_patience):
            logger.info(
    ...
    def _is_improvement(self, objective_value: Any) -> bool:
        ...
        if self.is_multi_objective:
            ...
            if isinstance(objective_value, (list, tuple)) and isinstance(self.best_value, (list, tuple)):
...
class OptimizationOrchestrator:
    ...
    def optimize(
        ...
        try:
            ...
            while not self.parameter_generator.is_finished() and not self.progress_tracker.should_stop():
            ...
            try:
                ...
                return OptimizationResult(
                    best_parameters={},
                    best_value=-1e9 if not self.evaluator.is_multi_objective else [-1e9] * len(self.evaluator.metrics_to_optimize),
