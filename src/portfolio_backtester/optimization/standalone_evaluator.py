...
def evaluate_walk_forward(scenario_config, monthly_data, daily_data, rets_full, metrics_to_optimize, is_multi_objective, windows, run_scenario_method, get_strategy_method, global_config, args, data_cache, random_state):
    ...
    final_metrics = calculate_metrics(full_pnl_returns, bench_period_rets, global_config["benchmark"])
