...
class GeneticOptimizer(BaseOptimizer):
    ...
    def _batch_fitness_function(self, ga_instance, solutions, solutions_indices):
        ...
        for sol in solutions:
            ...
            if any(p.get('type') == 'multi-categorical' for p in self.optimization_params_spec):
                ...
                multi_cat_param = next(p for p in self.optimization_params_spec if p.get('type') == 'multi-categorical')
                ...
                for i in range(1, 1 << len(choices)):
                    ...
                    temp_params[param_name] = selected_values
    ...
    def optimize(self):
        ...
        self.ga_instance = pygad.GA(
            ...
            on_generation=lambda ga_instance: logger.info(f"Generation {ga_instance.generations_completed} complete. Best fitness: {ga_instance.best_solution()[1]}")
        )
