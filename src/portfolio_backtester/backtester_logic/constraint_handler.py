...
class ConstraintHandler:
    ...
    def _try_other_adjustments(self, params: Dict, scenario_config: Dict, attempt: int) -> Optional[Dict]:
    ...
    def _check_constraint_violations(self, metrics: Dict, constraints_config: List[Dict]) -> List[str]:
