...
def test_comprehensive_directional_functionality():
    ...
    try:
        ...
        assert (
            stats["all_num_trades"] == stats["long_num_trades"] + stats["short_num_trades"]
        ), "Total should equal sum"

        print(
            f"✅ Trade counts: All={stats['all_num_trades']}, Long={stats['long_num_trades']}, Short={stats['short_num_trades']}"
        )
