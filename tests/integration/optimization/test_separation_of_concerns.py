...
class TestSeparationOfConcerns(BaseIntegrationTest):
    ...
    def test_no_backtesting_code_in_optimization_modules(self):
        ...
        optimization_modules = [
            'src.portfolio_backtester.optimization.orchestrator',
            'src.portfolio_backtester.optimization.evaluator',
            'src.portfolio_backtester.optimization.parameter_generator',
            'src.portfolio_backtester.optimization.factory',
            'src.portfolio_backtester.optimization.generators.optuna_generator',
            'src.portfolio_backtester.optimization.generators.genetic_generator'
        ]
        ...
        print(f"✓ No backtesting-specific code found in {len(optimization_modules)} optimization modules")
    ...
    def test_no_optimization_code_in_backtesting_modules(self):
        ...
        print(f"✓ No optimization-specific code found in {len(backtesting_modules)} backtesting modules")
                ...
                for module_name in backtesting_modules:
                    try:
                        ...
                        if any(opt_mod in str(e) for opt_mod in optimization_modules_to_mock):
                            self.fail(f"Backtesting module {module_name} depends on optimization modules: {e}")
