...
class TestConfigurableUniversesIntegration:
    ...
    def test_dummy_strategy_with_fixed_universe(self):
        """Test DummyStrategy with fixed universe configuration."""
        strategy_config = {
            "universe_config": {"type": "fixed", "tickers": ["AAPL", "MSFT", "GOOGL", "AMZN"]},
            "strategy_params": {
                "trade_longs": True,
                "trade_shorts": False,
            },
    ...
    def test_dummy_strategy_with_named_universe(self):
        """Test DummyStrategy with named universe configuration."""
        # Create test universe
        self.create_test_universe("tech_giants", "AAPL\nMSFT\nGOOGL\nAMZN\nNVDA\n")

        strategy_config = {"universe_config": {"type": "named", "universe_name": "tech_giants"}}
    ...
    def test_dummy_strategy_with_multiple_named_universes(self):
        """Test DummyStrategy with multiple named universes."""
    ...
    def test_dummy_strategy_with_method_universe(self, mock_sp500_func):
        """Test DummyStrategy with method-based universe."""
    ...
    def test_dummy_strategy_fallback_to_global(self):
        """Test DummyStrategy fallback to global universe when config fails."""
        strategy_config = {
    ...
    def test_dummy_strategy_no_universe_config(self):
        """Test DummyStrategy without universe_config (backward compatibility)."""
        strategy_config = {
            "strategy_params": {
                "trade_longs": True,
                "trade_shorts": False,
    ...
    def test_universe_configuration_validation(self):
        ...
        for config in invalid_configs:
            config["strategy_params"] = {"long_only": True}
...
class TestScenarioConfigurationCompatibility:
    ...
    def test_scenario_universe_override(self):
        ...
        strategy_config = {
            "universe_config": {"type": "fixed", "tickers": ["STRATEGY1", "STRATEGY2"]},
            "strategy_params": {
                "trade_longs": True,
                "trade_shorts": False,
            },
...
class TestPerformanceAndCaching:
    ...
    def test_universe_caching_across_strategies(self):
        ...
        strategy_config = {
            "universe_config": {"type": "named", "universe_name": "cached_universe"},
            "strategy_params": {
                "trade_longs": True,
                "trade_shorts": False,
            },
        ...
        strategy1 = DummyStrategy(strategy_config)
        strategy2 = DummyStrategy(strategy_config)
        strategy3 = DummyStrategy(strategy_config)
    ...
    def test_large_universe_performance(self):
        ...
        strategy_config = {
            "universe_config": {"type": "named", "universe_name": "large_universe"},
            "strategy_params": {
                "trade_longs": True,
                "trade_shorts": False,
            },
