...
class TestTimingConfigSchemaRefactored:
    ...
    def test_format_validation_report(self):
        ...
        errors = [
            ValidationError(
                field="mode", value="invalid", message="Invalid mode", suggestion="Use valid mode"
            )
        ]
...
"""
    ...
    def test_convenience_functions(self):
        ...
        config = {"timing_config": {"mode": "time_based", "rebalance_frequency": "M"}}
        ...
        invalid_config = {"timing_config": {"mode": "invalid_mode"}}
