...
class TestSignalBasedTiming:
    ...
    def create_signal_based_timing(self, config=None):
        ...
        ), f"Expected SignalBasedTiming, got {type(controller)}"
        return controller
    ...
    def setup_method(self):
        ...
        self.available_dates = pd.bdate_range(
            start="2023-01-01", end="2023-01-31", freq="B"  # Business days
        )
    ...
    def test_init_with_custom_config(self):
        ...
        config = {"scan_frequency": "W", "max_holding_period": 30, "min_holding_period": 5}
        timing = self.create_signal_based_timing(config)
    ...
    def test_config_validation_min_greater_than_max(self):
        ...
        config = {"min_holding_period": 10, "max_holding_period": 5}

        with pytest.raises(
            ValueError, match="min_holding_period .* cannot exceed max_holding_period"
        ):
            self.create_signal_based_timing(config)
    ...
    def test_should_generate_signal_within_min_holding_period(self):
        ...
        config = {"scan_frequency": "D", "min_holding_period": 5}
        timing = self.create_signal_based_timing(config)
    ...
    def test_should_generate_signal_force_rebalance_max_holding(self):
        ...
        config = {"scan_frequency": "D", "min_holding_period": 1, "max_holding_period": 5}
        timing = self.create_signal_based_timing(config)
...
class TestSignalBasedTimingEdgeCases:
    ...
    def test_empty_date_range(self):
        ...
        rebalance_dates = timing.get_rebalance_dates(start_date, end_date, available_dates, Mock())
