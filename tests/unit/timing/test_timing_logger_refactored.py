...
class TestTimingLoggerRefactored:
    ...
    def setup_method(self):
        ...
        self.logger = TimingLogger(
            "test_refactored", enable_detailed_logging=True, log_level="DEBUG"
        )
    ...
    def test_signal_generation_logging(self):
        ...
        self.logger.log_signal_generation(
            strategy_name, current_date, True, "RSI below threshold", rsi_value=25.0
        )
    ...
    def test_position_update_logging(self):
        ...
        self.logger.log_position_update(strategy_name, current_date, "AAPL", "entry", 0.25, 150.0)
    ...
    def test_error_logging(self):
        ...
        self.logger.log_error(strategy_name, current_date, "ValidationError", "Invalid parameter")
