...
from portfolio_backtester.timing.state_management import PositionTracker, StateStatistics, StateSerializer
...
class TestTimingStateRefactored:
    ...
    def test_position_tracking(self):
        ...
        # Update positions
        changes = self.state.update_positions(date, weights, prices)
    ...
    def test_comprehensive_analysis(self):
        ...
        required_keys = [
            'portfolio_summary', 'position_statistics', 'performance_summary',
            'asset_analysis', 'weight_distribution', 'holding_period_analysis',
            'state_info'
        ]
