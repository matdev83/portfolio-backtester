...
class TestIntegrationWithExistingFramework:
    ...
    def test_enhanced_backward_compatibility(self):
        ...
        legacy_config = {"strategy_params": {"lookback_period": 252}, "rebalance_frequency": "M"}
    ...
    def test_configuration_examples_validation(self):
        ...
        if os.path.exists(examples_file):
            ...
            test_examples = ["basic_monthly_strategy", "daily_signal_strategy", "adaptive_strategy"]
            ...
            for example_name in test_examples:
                if example_name in examples:
                    ...
                    if "timing_config" in config:
                        ...
                        assert (
                            error_count == 0
                        ), f"Example {example_name} has validation errors: {errors}"
