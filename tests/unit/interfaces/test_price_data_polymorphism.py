...
from src.portfolio_backtester.interfaces.price_extractor_interface import (
    IPriceExtractor,
    DataFrameExtractor,
    SeriesExtractor,
    ScalarExtractor,
...
from src.portfolio_backtester.interfaces.series_normalizer_interface import (
    ISeriesNormalizer,
    SeriesNormalizer,
    DataFrameNormalizer,
...
class TestBackwardCompatibility:
    ...
    def test_extract_current_prices_compatibility(self):
        ...
        from src.portfolio_backtester.utils.price_data_utils import extract_current_prices
    ...
    def test_normalize_price_series_to_dataframe_compatibility(self):
        ...
        from src.portfolio_backtester.utils.price_data_utils import normalize_price_series_to_dataframe
...
class TestSOLIDCompliance:
        ...
        class CustomExtractor(IPriceExtractor):
            ...
            def extract(self, data, universe_tickers):
                if self.can_handle(data) and 'price' in data:
                    return pd.Series([data['price']], index=[universe_tickers[0]] if not universe_tickers.empty else [])
    ...
    def test_interface_segregation_principle(self):
        ...
        interface_methods = [method for method in dir(IPriceExtractor) 
        ...
        normalizer_methods = [method for method in dir(ISeriesNormalizer) 
                             if not method.startswith('_')]
