...
class TestOptimizationResult:
    ...
    def test_optimization_result_default_best_trial(self):
        ...
        result = OptimizationResult(
            best_parameters={}, best_value=0.0, n_evaluations=0, optimization_history=[]
        )
...
class TestOptimizationData:
    ...
    def test_optimization_data_creation(self):
        ...
        daily_data = pd.DataFrame(
            np.random.randn(len(dates), len(tickers)), index=dates, columns=tickers
        )
        ...
        opt_data = OptimizationData(
            monthly=monthly_data, daily=daily_data, returns=returns_data, windows=windows
        )
    ...
    def test_optimization_data_windows_format(self):
        ...
        opt_data = OptimizationData(
            monthly=pd.DataFrame(), daily=pd.DataFrame(), returns=pd.DataFrame(), windows=windows
        )
    ...
    def test_optimization_data_empty(self):
        ...
        opt_data = OptimizationData(
            monthly=pd.DataFrame(), daily=pd.DataFrame(), returns=pd.DataFrame(), windows=[]
        )
...
class TestResultDataClassesIntegration:
    ...
    def test_result_classes_type_safety(self):
        ...
        eval_result = EvaluationResult(
            objective_value=1.0, metrics={"test": 1.0}, window_results=[window_result]
        )

        opt_result = OptimizationResult(
            best_parameters={"test": 1.0}, best_value=1.0, n_evaluations=1, optimization_history=[]
        )
