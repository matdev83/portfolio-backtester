...
class TestNumbaKernelsExtended:
    def test_trade_tracking_kernel_reinvestment(self):
        ...
        # Day 1: Rebalance
        # Portfolio Value before rebal: 
        # Pos 0: 50 * 110 = 5500
        # Pos 1: 100 * 50 = 5000
        # Total: 10500
        # Target: 5250 per asset
        # New Pos 0: 5250 / 110 = 47.7272...
        # New Pos 1: 5250 / 50 = 105
        ...
        # Check positions at day 1 (rebalanced)
        expected_pos_0_d1 = 10500.0 * 0.5 / 110.0
        expected_pos_1_d1 = 10500.0 * 0.5 / 50.0
        assert np.isclose(positions[1, 0], expected_pos_0_d1)
        assert np.isclose(positions[1, 1], expected_pos_1_d1)
    ...
    def test_trade_tracking_kernel_fixed(self):
        ...
        # Rebalance target: still based on 10000 fixed capital! -> 5000 per asset
        # New Pos 0: 5000 / 200 = 25
        # New Pos 1: 5000 / 50 = 100
        
        assert np.isclose(portfolio_values[1], 15000.0)
        assert np.isclose(positions[1, 0], 25.0) # Reduced position because price went up but capital base is fixed
