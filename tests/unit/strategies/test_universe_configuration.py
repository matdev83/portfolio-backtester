...
class TestUniverseConfiguration:
    ...
    def test_fixed_universe_validation_errors(self):
        ...
        strategy_config = {"universe_config": {"type": "fixed", "tickers": []}}  # type: ignore
        strategy = MockStrategy(strategy_config)
        universe = strategy.get_universe(global_config)
        # Should fallback to global config
        assert universe == [("DEFAULT1", 1.0)]
        ...
        strategy_config = {
            "universe_config": {"type": "fixed", "tickers": "AAPL,MSFT"}  # String instead of list
        }
        strategy = MockStrategy(strategy_config)
        universe = strategy.get_universe(global_config)
        # Should fallback to global config
        ...
        strategy_config = {
            "universe_config": {"type": "fixed", "tickers": ["AAPL", 123, "MSFT"]}  # type: ignore  # Number in list
        }
        strategy = MockStrategy(strategy_config)
        universe = strategy.get_universe(global_config)
        # Should fallback to global config
    ...
    def test_named_universe_configuration(self):
        ...
        global_config = {"universe": ["DEFAULT1"]}
        strategy_config = {"universe_config": {"type": "named", "universe_name": "tech_stocks"}}
    ...
    def test_named_universe_validation_errors(self):
        ...
        strategy_config = {"universe_config": {"type": "named", "universe_names": []}}
        strategy = MockStrategy(strategy_config)
        universe = strategy.get_universe(global_config)
        # Should fallback to global config
        assert universe == [("DEFAULT1", 1.0)]
    ...
    def test_method_universe_unknown_method(self):
        ...
        global_config = {"universe": ["DEFAULT1"]}
        strategy_config = {"universe_config": {"type": "method", "method_name": "unknown_method"}}
    ...
    def test_unknown_universe_type(self):
        ...
        global_config = {"universe": ["DEFAULT1"]}
        strategy_config = {"universe_config": {"type": "unknown_type"}}
    ...
    def test_get_universe_method_with_date_non_method_type(self):
        ...
        global_config = {"universe": ["DEFAULT1"]}
        strategy_config = {"universe_config": {"type": "named", "universe_name": "test"}}
...
class TestBackwardCompatibility:
    ...
    def test_no_universe_config_uses_global(self):
        ...
        global_config = {"universe": ["AAPL", "MSFT", "GOOGL"]}
        strategy_config: dict = {}  # No universe_config
    ...
    def test_missing_global_universe(self):
        ...
        global_config: dict = {}  # No universe key
        strategy_config: dict = {}
