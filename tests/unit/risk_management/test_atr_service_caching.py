...
from src.portfolio_backtester.risk_management.atr_service import get_atr_service
...
class TestATRServiceCaching:
    ...
    def test_atr_service_cache_key_uniqueness(self):
        ...
        result2 = atr_service.calculate_atr(historical_data, pd.Timestamp("2023-01-19"), 14)  # Different date
        result3 = atr_service.calculate_atr(historical_data, pd.Timestamp("2023-01-20"), 10)  # Different length
