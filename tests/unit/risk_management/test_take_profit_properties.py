...
def test_no_take_profit_handler_properties(data):
    ...
    adjusted = handler.apply_take_profit(
        current_date, current_prices, weights, entry_prices, tp_levels
    )
...
def test_stop_loss_and_take_profit_relationship(data, take_profit_config):
    ...
    tp_levels = tp_handler.calculate_take_profit_levels(
        current_date, ohlc_data, weights, entry_prices
    )
