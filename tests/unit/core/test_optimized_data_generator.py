...
class TestOptimizedDataGenerator:
    ...
    def test_create_standardized_date_range(self):
        ...
        for start, end, freq in test_cases:
            date_range = OptimizedDataGenerator.create_standardized_date_range(start, end, freq)
    ...
    def test_create_business_date_range(self):
        ...
        bdate_range = OptimizedDataGenerator.create_business_date_range("2020-01-01", "2020-01-31")
    ...
    def test_validate_ohlcv_data_structure_valid(self):
        ...
        # Generate valid data
        data = OptimizedDataGenerator.generate_cached_ohlcv_data(
            tickers=("AAPL", "MSFT"), start_date="2020-01-01", end_date="2020-01-31", freq="B"
        )
    ...
    def test_validate_ohlcv_data_structure_invalid(self):
        ...
        incomplete_columns = pd.MultiIndex.from_product(
            [["AAPL"], ["Open"]], names=["Ticker", "Field"]
        )
    ...
    def test_validate_date_range_consistency(self):
        ...
        # Generate test data
        data = OptimizedDataGenerator.generate_cached_ohlcv_data(
            tickers=("AAPL",), start_date="2020-01-01", end_date="2020-01-31", freq="B"
        )
