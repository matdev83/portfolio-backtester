...
class TestAdvancedVisualizations:
    ...
    def mock_backtester(self):
        ...
        backtester.global_config = {
            ...
            "advanced_reporting_config": {"enable_advanced_parameter_analysis": True},
        }
        backtester.scenarios = [
            {"name": "Test_Scenario", "strategy": "momentum", "universe": ["AAPL", "MSFT", "GOOGL"]}
        ]
    ...
    def test_plot_stability_measures(
        self, mock_backtester, mock_optimization_result, sample_returns
    ):
        ...
        with (
            ...
            plot_stability_measures(
                mock_backtester, "Test_Scenario", mock_optimization_result, sample_returns
            )
    ...
    def test_plot_stability_measures_insufficient_trials(self, mock_backtester, sample_returns):
        ...
        with patch("matplotlib.pyplot.savefig") as mock_savefig:
            ...
            plot_stability_measures(
                mock_backtester, "Test_Scenario", optimization_result, sample_returns
            )
    ...
    def test_plot_parameter_impact_analysis(self, mock_backtester, mock_best_trial):
        ...
        with (
            ...
            _plot_parameter_impact_analysis(
                mock_backtester, "Test_Scenario", mock_best_trial, timestamp
            )
    ...
    def test_create_parameter_importance_ranking(self, mock_backtester):
        ...
        objective = (
            important_param * 0.8 + less_important_param * 0.2 + np.random.randn(n_points) * 0.1
        )
    ...
    def test_plot_monte_carlo_robustness_analysis(self, mock_backtester):
        ...
        optimal_params = {"lookback_months": 9, "num_holdings": 15, "leverage": 1.2}
        ...
        daily_data = pd.DataFrame(
            np.random.randn(100, 4), columns=["AAPL", "MSFT", "GOOGL", "SPY"], index=dates
        )
    ...
    def test_plot_file_naming_and_paths(
        self, mock_backtester, mock_optimization_result, sample_returns
    ):
    ...
    def test_interactive_mode_handling(self, mock_backtester, sample_returns):
        ...
        with (
            ...
            plot_performance_summary(mock_backtester, sample_returns, None)
