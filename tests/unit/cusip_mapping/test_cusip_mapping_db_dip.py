...
class TestCusipMappingDBDependencyInjection:
    ...
    def test_initialization_with_default_loaders(self):
        ...
        with (
            patch("portfolio_backtester.cusip_mapping.create_seed_loader") as mock_seed_factory,
    ...
    def test_initialization_with_injected_loaders(self):
        ...
        db = CusipMappingDB(seed_loader=mock_seed_loader, live_db_loader=mock_live_db_loader)
    ...
    def test_resolve_handles_missing_ticker(self):
        ...
        with (
            patch("portfolio_backtester.cusip_mapping.lookup_openfigi"),
    ...
    def test_dependency_inversion_principle_compliance(self):
        ...
        db = CusipMappingDB(seed_loader=custom_seed_loader, live_db_loader=custom_live_loader)
    ...
    def test_loader_interface_type_checking(self):
        ...
        db = CusipMappingDB(seed_loader=valid_seed_loader, live_db_loader=valid_live_loader)
