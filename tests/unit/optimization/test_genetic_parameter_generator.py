...
class TestGeneSpaceConstruction:
    ...
    def test_invalid_parameter_space_empty(self):
        ...
        scenario_config = {}
        optimization_config = {"parameter_space": {}, "metrics_to_optimize": ["sharpe_ratio"]}
    ...
    def test_invalid_parameter_space_missing_bounds(self):
        ...
        scenario_config = {}
        optimization_config = {
            "parameter_space": {"param1": {"type": "int"}},  # Missing low and high
            "metrics_to_optimize": ["sharpe_ratio"],
        }
    ...
    def test_invalid_parameter_space_invalid_range(self):
        ...
        scenario_config = {}
        optimization_config = {
            "parameter_space": {"param1": {"type": "int", "low": 10, "high": 5}},  # low >= high
            "metrics_to_optimize": ["sharpe_ratio"],
        }
    ...
    def test_unsupported_parameter_type(self):
        ...
        scenario_config = {}
        optimization_config = {
            "parameter_space": {"param1": {"type": "unsupported", "low": 0, "high": 1}},
            "metrics_to_optimize": ["sharpe_ratio"],
        }
...
class TestChromosomeEncodingDecoding:
    ...
    def test_encode_parameters(self):
        ...
        parameters = {"lookback": 20, "alpha": 0.5, "method": "B"}
    ...
    def test_encode_decode_roundtrip(self):
        ...
        # Original parameters
        original_params = {"lookback": 25, "alpha": 0.7, "method": "C"}
    ...
    def test_decode_invalid_chromosome_length(self):
        ...
        with pytest.raises(
            ValueError, match="Chromosome length .* doesn't match parameter space size"
        ):
...
class TestParameterGeneratorInterface:
    ...
    def test_single_objective_optimization(self):
        ...
        scenario_config = {}
        optimization_config = {
            "parameter_space": {"param1": {"type": "int", "low": 1, "high": 10}},
            "metrics_to_optimize": ["sharpe_ratio"],
            "max_evaluations": 10,
        ...
        with patch.object(generator, "_external_fitness_function", return_value=0.0):
            with patch.object(
                generator.ga_instance, "population", np.array([[5.0], [7.0], [3.0], [9.0]])
            ):
                ...
                result = EvaluationResult(
                    objective_value=1.5, metrics={"sharpe_ratio": 1.5}, window_results=[]
                )
    ...
    def test_multi_objective_optimization(self):
        ...
        optimization_config = {
            ...
            "optimization_targets": [{"direction": "maximize"}, {"direction": "minimize"}],
            "max_evaluations": 10,
            "genetic_algorithm_params": {
                "num_generations": 5,
                "sol_per_pop": 10,
...
class TestErrorHandling:
    ...
    def test_report_result_invalid_parameters(self):
        ...
        result = EvaluationResult(
            objective_value=1.0, metrics={"sharpe_ratio": 1.0}, window_results=[]
        )
