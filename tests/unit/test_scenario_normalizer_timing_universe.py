...
def test_normalize_timing_no_conflict():
    ...
    # Both same
    scenario = {"strategy": "S", "rebalance_frequency": "W", "timing_config": {"rebalance_frequency": "W"}}
    canon = normalizer.normalize(scenario=scenario, global_config=global_config)
    assert canon.timing_config["rebalance_frequency"] == "W"

def test_normalize_timing_conflict():
    normalizer = ScenarioNormalizer()
    global_config = {}
    
    scenario = {"strategy": "S", "rebalance_frequency": "W", "timing_config": {"rebalance_frequency": "D"}}
...
def test_normalize_universe_no_conflict():
    normalizer = ScenarioNormalizer()
    global_config = {}
...
def test_normalize_universe_conflict():
    normalizer = ScenarioNormalizer()
    global_config = {}
...
def test_normalize_wfo_overrides():
    normalizer = ScenarioNormalizer()
    global_config = {
...
def test_normalize_extras_preservation():
    normalizer = ScenarioNormalizer()
    global_config = {}
