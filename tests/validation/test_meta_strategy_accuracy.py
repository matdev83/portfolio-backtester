...
class TestMetaStrategyAccuracy:
    ...
    def test_simple_two_strategy_validation(self, controlled_market_data):
        ...
        scenario_config = {"strategy_params": config, "timing_config": {"rebalance_frequency": "M"}}
        ...
        assert (
            abs(meta_return - manual_return) < 0.001
        ), f"Meta strategy return {meta_return:.6f} != Manual return {manual_return:.6f}"

    def _calculate_manual_return(
        self, trades: List[TradeRecord], market_data: pd.DataFrame, initial_capital: float
    ) -> float:
    ...
    def test_zero_trades_scenario(self):
        ...
        columns = pd.MultiIndex.from_product(
            [["AAPL", "SPY"], ["Close"]], names=["Ticker", "Field"]
        )
    ...
    def test_single_trade_accuracy(self):
        ...
        columns = pd.MultiIndex.from_product(
            [["AAPL", "SPY"], ["Open", "High", "Low", "Close", "Volume"]], names=["Ticker", "Field"]
        )
    ...
    def test_overlapping_trades_accuracy(self, controlled_market_data):
        ...
        scenario_config = {"strategy_params": config, "timing_config": {"rebalance_frequency": "W"}}
        ...
        config = {
            ...
            "allocations": [
                ...
                },
                {
                    ...
                    "strategy_class": "SeasonalSignalStrategy",
                    "strategy_params": {"entry_day": 1, "timing_config": {"mode": "signal_based"}},
                    "weight": 0.25,
                },
                {
