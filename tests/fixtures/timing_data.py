...
class TimingDataFixture:
    ...
    def create_rebalance_dates(
        start_date: str = "2020-01-01", end_date: str = "2023-12-31", frequency: str = "ME"
    ) -> pd.DatetimeIndex:
        """
    ...
    def create_available_dates(
        start_date: str = "2020-01-01", end_date: str = "2023-12-31", freq: str = "B"
    ) -> pd.DatetimeIndex:
        """
    ...
    def create_mock_strategy_context(
        strategy_name: str = "TestStrategy", config: Optional[Dict[str, Any]] = None
    ) -> Mock:
        """
    ...
    def create_timing_state_scenarios() -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "active_state": {
                "scheduled_dates": ["2020-01-31", "2020-02-29", "2020-03-31"],
    ...
    def get_expected_rebalance_dates(
        config: Dict[str, Any], start_date: str, end_date: str
    ) -> List[str]:
        """
